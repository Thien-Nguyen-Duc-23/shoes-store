                      ...
                      <div class="product-box col-lg-12 col-md-12 col-sm-12 col-xs-12">															
                        <div class="product-thumbnail display_flex">
                          <div class="owl_product_item_content owl-carousel not-dot2" data-loop="true" data-dot="false" data-nav='false' data-lg-items='1' data-md-items='1' data-sm-items='1' data-xs-items="1" data-margin='0'>
                            <div class="item">
                              <a class="image_link" href="chan-vay-dui-tron.html" title="{{ $newProduct->name }}">
                                @php
                          ...
                          <div class="product-action-grid clearfix ">
                            <form action="https://homiessg.vn/cart/add" method="post" class="variants form-nut-grid" data-id="product-actions-19441207" enctype="multipart/form-data">
                              <div>
                                <input class="hidden" type="hidden" name="variantId" value="37175085" />
                                <div class="action_btn">
                                  <button class="btn-cart button_h left-to" title="Tùy chọn"  type="button" onclick="window.location.href='chan-vay-dui-tron.html'" >
                        ...
                        <div class="product-info a-left">
                          <h3 class="product-name">
                            <a href="chan-vay-dui-tron.html" title="{{ $newProduct->name }}">{{ $newProduct->name }}
                            </a>
                          </h3>
